import { Address, AddressType, AliasAction, Customer, DccRateData, EcommerceInfo, EmvLastChipRead, GiftCard, HostedPaymentData, InquiryType, IPaymentMethod, MerchantCategory, OrderDetails, PaymentMethodUsageMode, PhoneNumber, PhoneNumberType, RecurringSequence, RecurringType, StoredCredential, StoredCredentialInitiator, Transaction } from "../";
...
export declare class AuthorizationBuilder extends TransactionBuilder<Transaction> {
    ...
    emvChipCondition: EmvLastChipRead;
     ...
     * @returns AuthorizationBuilder
     */
    withCustomerData(customerData: Customer): this;
    /**
    ...
    withShippingAmount(shippingAmount: string | number): this;
    withOrderDetails(orderDetails: OrderDetails): this;
    /**
     ...
     * @returns AuthorizationBuilder
     */
    withRequestMultiUseToken(requestMultiUseToken?: boolean, requestUniqueToken?: boolean): AuthorizationBuilder;
    ...
    withProductData(productData: Record<string, string>[]): this;
    withPhoneNumber(phoneCountryCode: string, value: string, phoneNumberType: PhoneNumberType): this;
    withIdempotencyKey(idempotencyKey?: string): this;
    withMultiCapture(multiCapture?: boolean): this;
    withStoredCredentials(storedCredential: StoredCredential): this;
    withChipCondition(value: EmvLastChipRead): this;
    withTagData(value: string): this;
    withAmountEstimated(value: boolean): this;
    withMerchantCategory(merchantCategory: MerchantCategory): this;
    /**
