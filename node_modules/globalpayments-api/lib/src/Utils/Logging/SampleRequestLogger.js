...
exports.SampleRequestLogger = void 0;
class SampleRequestLogger {
    logger;
    constructor(logger) {
        this.logger = logger;
    }
    requestSent(verb, endpoint, requestId, headers, data) {
        ...
        this.logger.info("Request endpoint: " + endpoint, requestId, undefined, true);
